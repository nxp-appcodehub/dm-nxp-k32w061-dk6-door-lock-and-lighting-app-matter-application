...
public:
    ...
    void UpdateDoorLockClusterState(void);
    void UpdateLockDeviceState(void);
...
private:
    ...
    static void LockManagerCallback(LockManager::LockManagerEvent event);
    ...
    static void UpdateDoorLockClusterStateInternal(intptr_t arg);
    static void UpdateLockDeviceStateInternal(intptr_t arg);
